...
void setup() {
  ...
  guards.add(new Security(200, 200));
  guards.add(new Security(600, 400));
  guards.add(new Security(-500, 900));
  guards.add(new Security(1000, -300));
  guards.add(new Security(-700, -200));
